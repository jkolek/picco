...
public:
    ...
    virtual void visit(GetCharExprASTNode *n);
    virtual void visit(PutCharExprASTNode *n);
    virtual void visit(GetIntExprASTNode *n);
    virtual void visit(PutIntExprASTNode *n);
    ...
    virtual void visit(ListASTNode *n);
};
