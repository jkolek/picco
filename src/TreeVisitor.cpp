...
void TreeVisitor::visit(GetCharExprASTNode *n) { n->getExpr()->accept(this); }

void TreeVisitor::visit(PutCharExprASTNode *n) { n->getExpr()->accept(this); }

void TreeVisitor::visit(GetIntExprASTNode *n) { n->getExpr()->accept(this); }

void TreeVisitor::visit(PutIntExprASTNode *n) { n->getExpr()->accept(this); }
...
void TreeVisitor::visit(ListASTNode *n)
{
