...
void GetCharExprASTNode::accept(TreeVisitor *v) { v->visit(this); }

void PutCharExprASTNode::accept(TreeVisitor *v) { v->visit(this); }

void GetIntExprASTNode::accept(TreeVisitor *v) { v->visit(this); }

void PutIntExprASTNode::accept(TreeVisitor *v) { v->visit(this); }
...
void ListASTNode::accept(TreeVisitor *v) { v->visit(this); }
