...
void PrintTreeVisitor::visit(GetCharExprASTNode *n) { /* TODO: Implement. */}

void PrintTreeVisitor::visit(PutCharExprASTNode *n)
{
    _level++;
    printTab(_level);
    std::cout << "NK_PUTC_EXPR" << std::endl;
    if (n->getExpr() != NULL_AST_NODE)
    {
        printTab(_level);
        std::cout << "Expression:" << std::endl;
...
void PrintTreeVisitor::visit(GetIntExprASTNode *n) { /* TODO: Implement. */}

void PrintTreeVisitor::visit(PutIntExprASTNode *n)
{
    _level++;
    printTab(_level);
    std::cout << "NK_PUTI_EXPR" << std::endl;
    if (n->getExpr() != NULL_AST_NODE)
    {
        printTab(_level);
        std::cout << "Expression:" << std::endl;
...
void PrintTreeVisitor::visit(ListASTNode *n)
{
    _level++;
    printTab(_level);
